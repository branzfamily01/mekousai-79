(() => {
  ...
  function enhance(){
    ...
    list.querySelectorAll('.editor-photo[data-photo-id]').forEach(card => {
      ...
      const actions = card.querySelector('.editor-photo-actions') || card.querySelector('.editor-actions') || card;
      const button = document.createElement('button');
      button.type='button'; button.className='editor-mini-button festival-group-cover-button';
